...
const ViewBookSkeleton = () => {
  <div className="animate-pulse">
    <div className="h-8 bg-slate-200 w-1/2 mb-4"></div>
    <div className="h-4 bg-slate-200 w-1/4 mb-8"></div>
    ...
    <DashboardLayout>
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed border-slate-200 rounded-xl mt-8">
          <div className="h-16 w-16 bg-slate-100 rounded-full items-center justify-center mb-4">
