...
import SimpleMDEditor from "../ui/SimpleMDEditor"
        ...
        return (
            <div className="flex-1 flex item-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm mt-1">Choose from the sidebar nto begin writing</p>
                </div>
            </div>
        );
    }
                        ...
                        <div className="space-y-6 h-full flex flex-col">
                            ...
                            <div>
                                <InputField
                                    ...
                                    className="text-xl flex-semibold"
                                />
                            </div>
                            ...
                            <div className="flex-1 min-h-0 ">
                                {isPreviewMode ? (
                                    <div className="h-full border bg-gray-200 rounded-lg overflow-y-auto">
