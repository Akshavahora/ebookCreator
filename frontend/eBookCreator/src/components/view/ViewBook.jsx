    ...
    <div className="flex h-[calc(100vh-64px)] bg-white text-gray-900">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between p-4 border-b border-gray-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-semibold text-base ms:text-lg truncate">{book.title}</h1>
          ...
          <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="flex justify-between items-center mt-16 pt-8 border-t border-gray-200">
              ...
              <button
                ...
                className="flex items-center gap-2 py-2 px-4 bg-gray-200 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Next Chapter
      ...
      <style jsx> {
          ...
          .reading-content strong {
            font-weight: 600;
            color: #1f2937; /* Darker shade for strong text */
          }
