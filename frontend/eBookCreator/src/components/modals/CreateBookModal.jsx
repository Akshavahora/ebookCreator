          ...
          >
            {chapters.length === 0 ?(
              <div className="text-center py-12 px-4 bg-gray-50 rounded-xl">
                <BookOpen className="w-12 h-12 to-gray-300 mx-auto mb-3" />
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <input
                      ...
                      className="flex-1 text-base font-medium to-gray-900 bg-transparent border-none focus:outline-none focus:ring-0 p-0"
                    />
                    <button
