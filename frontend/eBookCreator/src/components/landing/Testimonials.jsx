...
const Testimonials = () => {
  return (
    <div id='testimonials' className="relative py-24 lg:py-32 bg-gradient-to-br from-violet-50 via-purple-50 to-white overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-20 right-20 w-64 h-64 bg-violet-200/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-violet-200/30 rounded-full blur-3xl"></div>

        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            {/* Header */}
            <div className="text-center mb-20 space-y-4">
                <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 rounded-full border border-violet-100 shadow-sm
                ">
                ...
                mx-auto">
                    Don't just take our word fot it. Here's what our users have to say about their experience.  
                </p>
            </div>
                         ...
                         items-center space-x-4">
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-br
                                 from-violet-500 to-purple-600 rounded-full blur-2xl opacity-30"></div>
                                <img 
                                    className='relative w-14
                                     h-14 rounded-full object-cover ring-2 ring-white shadow-lg' 
