...
const Hero = () => {
    ...
    return (
        <div className="relative bg-gradient-to-br from-violet-50 via-white to-purple-50 overflow-hidden">
            ...
            <div className="absolute top-20 left-10 h-64 bg-violet-200/30 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute bottom-20 right-10 h-64 bg-purple-200/20 rounded-full blur-3xl animate-pulse delay-700"></div>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="max-w-xl space-y-8">
                        ...
                        <h1 className="text-5xl sm:text-6xl lg:text-6xl font-bold text-gray-900 leading-tight transform-tight">
                            Create Amazing
                            <span className="block mt-2 bg-gradient-to-r from-violet-900 via-purple-600 to-violet-600 bg-clip-text text-transparent">
                                Ebooks in Minutes
                            </span>
                        </h1>

                        <p className="text-lg text-gray-600 leading-relaxed">
                            Every great book starts with an idea. Let AI help you write, design, and publish beautiful eBooks faster than ever before.
                        </p>
                        ...
                        <div className="flex items-center gap-8 pt-4">
                            <div>
                                ...
                                <div className="text-sm text-gray-600">Book Created</div>
                            </div>
