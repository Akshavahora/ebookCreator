...
? `${BASE_URL}/backend/${book.coverImage}`.replace(/\\/g,"/")
    ...
    return(
      <div 
        className="group relative bg-white overflow-hidden border border-gray-100 hover:border-gray-200 transition-all duration-300 hover:shadow-xl hover-shadow-gray-100/50 hover:translate-y-1 cursor-pointer"
      ...
      >
        <div className="relative overflow-hidden bg-linear-to-br from-gray-50 to-gray-100">
          ...
          <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex gap-2">
            <button 
              ...
              className="w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-colors curser-pointer"
            >
            ...
            <button 
              ...
              className="w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-red-50 transition-colors curser-pointer group/delete"
            >
        ...
        <div className="absolute bottom-0 left-0 ring-0 h-[3px] bg-linear-to-r from-orange-500 via-amber-500 to-rose-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
    )
}
